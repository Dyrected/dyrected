...
>(({ className, ...props }, ref) => (
  <th
    ref={ref}
    className={cn(
      "dy-h-12 dy-px-4 dy-text-left dy-align-middle dy-font-medium dy-text-muted-foreground [&:has([role=checkbox])]:dy-pr-0",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <td
    ref={ref}
    className={cn("dy-p-4 dy-align-middle [&:has([role=checkbox])]:dy-pr-0", className)}
    {...props}
  />
))
