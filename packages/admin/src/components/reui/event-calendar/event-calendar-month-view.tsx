    ...
    <EventCalendarViewContext.Provider value={{ view: "month" }}>
      ...
      >
          ...
          {headerDays.map((day) => (
            ...
            >
              {viewConfig.renderDayHeader?.({
                ...
                <>
                  <span className="@max-[36rem]:dy-hidden">
                    {format(
                  ...
                  <span className="dy-hidden @max-[36rem]:dy-inline">
                    {format(
                      toZoned(day, settings.timeZone),
        ...
        <div
          ...
          className={cn(
            "dy-grid",
            contained && "dy-min-h-0 dy-flex-1",
        ...
        {autoFit && (
          <div
            ref={slotProbeRef}
            aria-hidden
            className="dy-pointer-events-none dy-invisible dy-absolute dy-h-[var(--ec-month-bar-h,1.75rem)] dy-w-0"
          />
        )}
      </Comp>
    ...
    >
      ...
      {(visibleBars.length > 0 || (dragGhost && ghostPos && ghostIsBar)) && (
        <div
          ...
          className={cn(
            "dy-pointer-events-none dy-absolute dy-inset-x-0 dy-top-0 dy-z-10 dy-grid dy-pt-1.5",
          ...
          {visibleBars.map((bar) => {
            ...
            return (
              ...
              >
                ...
                <EventCalendarEvent
                  segment={bar}
                  className="dy-h-[calc(var(--ec-month-bar-h,1.75rem)-0.125rem)]"
                />
              </div>
            )
          })}
          {dragGhost && ghostPos && ghostIsBar && (
            ...
            >
              <div
                ...
                className={cn(
                  "dy-h-[calc(var(--ec-month-bar-h,1.75rem)-0.125rem)]",
                  dragGhost.kind === "move"
...
function EventCalendarMonthCell({
   ...
   *  because the bar overlay renders after the cells, so `:dy-last-child` is
    ...
    <>
      <div
        ...
        className={cn(
          ...
          "dy-flex dy-min-h-0 dy-flex-1 dy-flex-col dy-gap-0.5 dy-overflow-hidden dy-px-1 dy-pt-1.5",
    ...
    >
      {inDraft && (
        <span
          ...
          className={cn(
            "dy-pointer-events-none dy-absolute dy-inset-0 dy-z-10",
        ...
        >
          ...
          {inDraft.isStart && draftRange && (
            <span
              className={cn(
                "dy-absolute dy-inset-x-1 dy-bottom-1",
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger
        ...
        className={cn(
          "dy-text-muted-foreground hover:dy-text-foreground dy-cursor-pointer dy-truncate dy-rounded-sm dy-px-1.5 dy-text-start",
      ...
      <PopoverContent
        ...
        className={cn(
          "dy-w-64 dy-gap-1! dy-p-2! dy-text-xs",
  ...
  return (
    <>
      <div
        id={headerId}
        className={cn(
          "dy-text-muted-foreground dy-px-1 dy-py-1 dy-text-xs dy-font-medium",
      ...
      {viewConfig.scrollbars === "native" ? (
        <div
          ...
          className="-dy-me-2 dy-max-h-[var(--ec-more-max-height,16rem)] dy-min-h-0 dy-overflow-y-auto"
        >
          <div className="dy-flex dy-flex-col dy-gap-1 dy-py-1 dy-ps-1 dy-pe-4">
        ...
        <ScrollArea className="-dy-me-2 dy-min-h-0 **:data-[slot=scroll-area-viewport]:dy-max-h-[var(--ec-more-max-height,16rem)]">
          <div className="dy-flex dy-flex-col dy-gap-1 dy-py-1 dy-ps-1 dy-pe-4">
            {segments.map((segment) => (
              <EventCalendarEvent
                key={segment.occurrence.key}
