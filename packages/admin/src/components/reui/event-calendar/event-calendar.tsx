...
interface EventCalendarViewConfig<TData = unknown> {
  ...
  shortcutsScope: "dy-focus-within" | "global"
  /**
   ...
   * e.g. "dy-bg-amber-500/10"). Applied to month cells, time-grid day columns,
...
const DEFAULT_VIEW_CONFIG: EventCalendarViewConfig = {
  ...
  shortcutsScope: "dy-focus-within",
    ...
    <EventCalendarContext.Provider value={instance}>
      <EventCalendarViewConfigContext.Provider value={viewConfig}>
        <Comp
          ...
          // e.g. <EventCalendar className="dy-text-sm"> and every inheriting
          ...
          className={cn("dy-flex dy-min-h-0 dy-min-w-0 dy-flex-col dy-text-xs", className)}
          {...rest}
        >
