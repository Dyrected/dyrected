...
function EventCalendarTimeGrid({
  ...
  useEffect(() => {
    ...
    const syncScrollbarGutter = () => {
      root?.style.setProperty(
        "--ec-scrollbar-w",
        `${viewport ? viewport.offsetWidth - viewport.clientWidth : 0}dy-px`
      )
    }
    syncScrollbarGutter()
  ...
  const track = (
    <div className="dy-relative dy-flex">
  ...
  return (
    <EventCalendarViewContext.Provider value={{ view }}>
      ...
      >
        ...
        {contained ? (
          <div ref={scrollRef} className="dy-min-h-0 dy-flex-1">
            {viewConfig.scrollbars === "native" ? (
              ...
              <ScrollArea className="dy-h-full">{track}</ScrollArea>
            )}
          </div>
        ) : (
          track
...
function EventCalendarAllDayBars({
  ...
  return (
    <div className="dy-relative dy-min-w-0 dy-flex-1">
      <div
        className="dy-grid dy-h-full"
        style={{
          gridTemplateColumns,
      ...
      {(bars.length > 0 || dragGhost) && (
        <div
          ...
          className="dy-pointer-events-none dy-absolute dy-inset-x-0 dy-top-0 dy-grid dy-pt-1.5"
          style={{
            gridTemplateColumns,
        ...
        >
          {bars.map((segment) => (
            ...
            >
              <EventCalendarEvent
                segment={segment}
                className="dy-h-[calc(var(--ec-month-bar-h,1.625rem)-0.125rem)]"
              />
            </div>
          ))}
          {dragGhost && (
            <div
              aria-hidden
              className={cn("dy-min-w-0 dy-px-1", viewConfig.classNames?.monthBar)}
              style={{
            ...
            >
              <div
                ...
                className={cn(
                  "dy-h-[calc(var(--ec-month-bar-h,1.625rem)-0.125rem)]",
                  dragGhost.kind === "move"
                    ? cn(
    ...
    >
      ...
      {inDraft?.isStart && allDayDraftRange && (
        <span
          aria-hidden
          className={cn(
            "dy-pointer-events-none dy-absolute dy-inset-x-1 dy-top-1/2 -dy-translate-y-1/2",
        ...
        return (
          ...
          >
            {label != null && (
              <span
                className={cn(
                  "dy-text-muted-foreground dy-absolute dy-end-2.5 -dy-top-2",
  ...
  return (
    ...
    >
      {viewConfig.renderDayColumnBackground && (
        <div className="dy-pointer-events-none dy-absolute dy-inset-0">
          {viewConfig.renderDayColumnBackground({
            day,
            boundsStartMin,
            boundsEndMin,
      ...
      {packedTimed.map((segment) => {
        ...
        return (
          <div
            ...
            className="dy-absolute dy-z-[var(--ec-z)] dy-min-h-[var(--ec-event-min-h,1.5rem)] dy-px-0.5 hover:dy-z-40"
            style={
              {
          ...
          >
            <EventCalendarEvent
              segment={segment}
              className={cn(
                columnCount > 1 && "dy-ring-background dy-ring-1",
      ...
      {dragGhost && (
        <div
          ...
          data-drop-invalid={!dragGhost.valid || undefined}
          className={cn(
            "dy-pointer-events-none dy-absolute dy-inset-x-0.5 dy-z-50 dy-min-h-[var(--ec-event-min-h,1.5rem)]",
            dragGhost.kind === "move"
              ? cn(
                  EVENT_CALENDAR_GHOST.move,
                  !dragGhost.valid && EVENT_CALENDAR_GHOST.invalid
      ...
      {draftWindow && (
        <div
          ...
          className={cn(
            ...
            "dy-pointer-events-none dy-absolute dy-inset-x-0.5 dy-z-40 dy-overflow-hidden",
            viewConfig.classNames?.slotDraft
          )}
...
function EventCalendarNowIndicator({
  ...
  if (viewConfig.renderNowIndicator) {
    return (
      <div
        className="dy-pointer-events-none dy-absolute dy-inset-x-0 dy-z-40"
  ...
  return (
    ...
    >
      ...
      <div className="dy-bg-destructive/40 dy-absolute dy-start-[var(--ec-gutter-width,4.5rem)] dy-end-0 dy-h-px" />
      {/* stronger segment + dot over today's column */}
      <div
        className="dy-absolute dy-h-px"
        style={{
