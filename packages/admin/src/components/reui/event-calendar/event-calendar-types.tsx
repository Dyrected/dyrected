...
/** A click is a point, not a range; `dy-end` is present for timed slots. */
...
/** Off-days; `true` = weekend defaults. Marked cells carry `dy-data-off`. */
interface EventCalendarOffDaysConfig {
  ...
  /** Marker classes; default "dy-bg-muted/25". */
  className?: string
}
