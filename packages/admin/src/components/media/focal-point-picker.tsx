  ...
  return (
    <div className="dy-space-y-2">
      ...
      >
        ...
        >
          <div className="dy-w-1.5 dy-h-1.5 dy-bg-background dy-rounded-full dy-shadow-sm" />
          <div className="dy-absolute dy-w-full dy-h-px dy-bg-background/40" />
          <div className="dy-absolute dy-h-full dy-w-px dy-bg-background/40" />
        </div>
