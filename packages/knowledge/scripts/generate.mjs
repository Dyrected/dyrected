...
const fieldPageContracts = {
  ...
  "number.mdx": ["NumberField", "NumberFieldAdmin"],
  "date.mdx": ["DateField"],
  "datetime.mdx": ["DateTimeField"],
  "time.mdx": ["TimeField"],
  "select.mdx": ["SelectField", "SelectFieldAdmin"],
  "multi-select.mdx": ["MultiSelectField", "MultiSelectFieldAdmin"],
  "url.mdx": ["UrlField", "UrlFieldAdmin", "UrlLinkValue"],
  "icon.mdx": ["IconField", "IconFieldAdmin"],
  "radio.mdx": ["RadioField", "RadioFieldAdmin"],
  "boolean.mdx": ["BooleanField", "BooleanFieldAdmin"],
