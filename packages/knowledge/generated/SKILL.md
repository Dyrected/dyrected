...
- “build reactive form transforms that survive Cloud schema sync” → [Declarative reactive hooks with JEXL and when](https://docs.dyrected.com/docs/examples-and-recipes/library/declarative-reactive-hooks)
- “compute field values without writing raw JavaScript functions” → [Declarative reactive hooks with JEXL and when](https://docs.dyrected.com/docs/examples-and-recipes/library/declarative-reactive-hooks)
- “calculate status-based pricing or conditional totals declaratively” → [Declarative reactive hooks with JEXL and when](https://docs.dyrected.com/docs/examples-and-recipes/library/declarative-reactive-hooks)
- “format reference codes or IDs from sibling inputs in real-time” → [Declarative reactive hooks with JEXL and when](https://docs.dyrected.com/docs/examples-and-recipes/library/declarative-reactive-hooks)
