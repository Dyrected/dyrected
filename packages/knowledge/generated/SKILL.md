...
- [Build a KYC review workspace](https://docs.dyrected.com/docs/examples-and-recipes/library/kyc-review-workspace) — Problem: Compliance reviewers need a focused queue of investors awaiting identity verification, with a visible count of pending work and one-click decisions, instead of searching a full investors collection. Summary: Define a standalone workspace with defineWorkspace that groups pending, approved, and rejected views over one collection, shows a live pending badge, and restricts access to reviewer roles.
...
- [Build an order fulfillment workspace](https://docs.dyrected.com/docs/examples-and-recipes/library/order-fulfillment-workspace) — Problem: A fulfillment team needs to move orders from requested to paid to shipped, see which orders still need payment, and watch revenue, without jumping between collection pages. Summary: Define a workspace with defineWorkspace that pairs a kanban pipeline with a filtered payment queue, metric cards, and a badge counting unpaid orders.
...
- [Build a support desk workspace](https://docs.dyrected.com/docs/examples-and-recipes/library/support-desk-workspace) — Problem: Support agents need a shared queue of open tickets, a fast way to spot urgent ones, and their own assigned tickets, without every agent seeing the same unfiltered list. Summary: Define a workspace with defineWorkspace containing open, urgent, and resolved views, a badge counting open tickets, and a resolve action.
...
- “build a KYC review queue” → [Build a KYC review workspace](https://docs.dyrected.com/docs/examples-and-recipes/library/kyc-review-workspace)
- “add a compliance workspace to the admin sidebar” → [Build a KYC review workspace](https://docs.dyrected.com/docs/examples-and-recipes/library/kyc-review-workspace)
- “show a pending count badge in navigation” → [Build a KYC review workspace](https://docs.dyrected.com/docs/examples-and-recipes/library/kyc-review-workspace)
- “approve or reject records with one click” → [Build a KYC review workspace](https://docs.dyrected.com/docs/examples-and-recipes/library/kyc-review-workspace)
...
- “build an order fulfillment dashboard” → [Build an order fulfillment workspace](https://docs.dyrected.com/docs/examples-and-recipes/library/order-fulfillment-workspace)
- “combine kanban and table views in one workspace” → [Build an order fulfillment workspace](https://docs.dyrected.com/docs/examples-and-recipes/library/order-fulfillment-workspace)
- “show unpaid orders count in the sidebar” → [Build an order fulfillment workspace](https://docs.dyrected.com/docs/examples-and-recipes/library/order-fulfillment-workspace)
- “add revenue metrics to an operations workspace” → [Build an order fulfillment workspace](https://docs.dyrected.com/docs/examples-and-recipes/library/order-fulfillment-workspace)
...
- “build a support ticket queue” → [Build a support desk workspace](https://docs.dyrected.com/docs/examples-and-recipes/library/support-desk-workspace)
- “add an urgent tickets view” → [Build a support desk workspace](https://docs.dyrected.com/docs/examples-and-recipes/library/support-desk-workspace)
- “resolve tickets with one click” → [Build a support desk workspace](https://docs.dyrected.com/docs/examples-and-recipes/library/support-desk-workspace)
- “show open ticket count in navigation” → [Build a support desk workspace](https://docs.dyrected.com/docs/examples-and-recipes/library/support-desk-workspace)
