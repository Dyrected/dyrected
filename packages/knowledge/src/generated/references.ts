...
export const references: readonly ReferenceEntry[] = [
  ...
  },
  {
    ...
    "members": [
      ...
      {
        "name": "detail",
        "signature": "detail?: DetailSchema<TDoc>",
        "description": "Presentation schema defining the layout and fields displayed in the Record Detail View.\n\nSee: [Detail Views overview](https://dyrected.com/docs/admin/detail-views)"
      }
    ]
  },
  {
  ...
  },
  {
    ...
    "members": [
      ...
      },
      {
        "name": "detail",
        "signature": "detail?: DetailSchema<TDoc>",
        "description": "Presentation schema defining the layout and fields displayed in the Global Detail View.\n\nSee: [Detail Views overview](https://dyrected.com/docs/admin/detail-views)"
      },
      {
        "name": "initialData",
        "signature": "initialData?: Partial<TDoc>",
