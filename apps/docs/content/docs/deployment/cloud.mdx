...
While you can always use the [Hosted Dashboard](https://cloud.dyrected.com) to manage content, embedding it into your own app is the "Pro" way to work. It allows you to:
