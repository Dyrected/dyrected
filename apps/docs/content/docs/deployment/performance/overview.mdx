...
That gives the database a real column instead of forcing repeated JSON extraction. For the full behavior, see [Indexes](/docs/basics/database/indexes).
...
- [Indexes](/docs/basics/database/indexes)
