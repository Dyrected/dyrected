...
**[Dyrected Cloud](/docs/deployment/cloud)** — create an account, run `dyrected push`, set two env vars, and your site is live. No database to provision, no storage bucket to configure, no infrastructure to maintain. Starts at $19/month.
