...
Use this page after [Installing Dyrected](/docs/quick-start-guides/vuejs-quick-start/installing-dyrected). At this point, the admin route should load, `dyrected.config.ts` should exist, and your Vue app should already know how to talk to Dyrected Cloud. The next job is deciding what content model the Cloud site actually needs.
...
Once that is true, continue to [Creating Your First Content](/docs/quick-start-guides/vuejs-quick-start/creating-your-first-content).
