...
Use this page when you are ready to add Dyrected to an existing Vue app and want the quickest path to a working admin. By the end, you should have the Cloud connection values in place, a generated `dyrected.config.ts`, an admin route mounted in your app, and be ready to move on to [Defining a Schema](/docs/quick-start-guides/vuejs-quick-start/defining-a-schema).
...
Once those are true, continue to [Defining a Schema](/docs/quick-start-guides/vuejs-quick-start/defining-a-schema).
