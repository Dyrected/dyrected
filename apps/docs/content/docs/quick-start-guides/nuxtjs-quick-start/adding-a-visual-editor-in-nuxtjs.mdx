...
Once that is true, continue to [Let Editors Build Custom Pages in Nuxt with Dyrected](/docs/quick-start-guides/nuxtjs-quick-start/building-landing-pages-for-marketing).
