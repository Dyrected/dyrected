...
For the full troubleshooting guide, see [Troubleshooting](/docs/features/troubleshooting/troubleshooting). That is the right top-level home for deeper error-by-error fixes.
...
Once those are true, continue to [Defining a Schema](/docs/quick-start-guides/nuxtjs-quick-start/defining-a-schema).
