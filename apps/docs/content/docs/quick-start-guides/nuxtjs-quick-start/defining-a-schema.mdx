...
Use this page after [Installing Dyrected](/docs/quick-start-guides/nuxtjs-quick-start/installing-dyrected). At this point, Dyrected is already mounted into your app and `/admin` should load. The next job is to turn the starter config into a schema that matches your real site instead of the generic example content.
...
Once that is true, continue to [Setting Up Initial Data](/docs/quick-start-guides/nuxtjs-quick-start/setting-up-initial-data).
