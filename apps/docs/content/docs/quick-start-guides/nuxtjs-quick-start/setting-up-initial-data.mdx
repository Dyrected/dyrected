...
- [Collections](/docs/basics/configuration/collections#initialdata)
...
Once that is true, continue to [Displaying Content in Nuxt](/docs/quick-start-guides/nuxtjs-quick-start/displaying-content-in-nuxtjs).
