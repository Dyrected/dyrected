...
Use this page after [Adding a Visual Editor in Nuxt](/docs/quick-start-guides/nuxtjs-quick-start/adding-a-visual-editor-in-nuxtjs). At this point, the important pieces should already exist:
...
- [Defining a Schema](/docs/quick-start-guides/nuxtjs-quick-start/defining-a-schema) shaped the content model
- [Setting Up Initial Data](/docs/quick-start-guides/nuxtjs-quick-start/setting-up-initial-data) made the first load non-empty
- [Displaying Content in Nuxt](/docs/quick-start-guides/nuxtjs-quick-start/displaying-content-in-nuxtjs) made the frontend render real content
- [Adding a Visual Editor in Nuxt](/docs/quick-start-guides/nuxtjs-quick-start/adding-a-visual-editor-in-nuxtjs) made editors preview and click into that content
...
- [Displaying Content in Nuxt](/docs/quick-start-guides/nuxtjs-quick-start/displaying-content-in-nuxtjs)
...
Once that is true, your Nuxt quick start is complete. When you are ready to give access to another person, continue to [Handing Off to Editors](/docs/features/authentication/handing-off-to-editors).
