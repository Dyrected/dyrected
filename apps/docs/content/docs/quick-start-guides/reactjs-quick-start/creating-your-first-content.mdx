...
If you need the deeper content-model background, go back to [Defining a Schema](/docs/quick-start-guides/reactjs-quick-start/defining-a-schema) and then use the broader [Collections](/docs/basics/configuration/collections) and [Globals](/docs/basics/configuration/globals) references.
...
Once that is true, continue to [Displaying Content in React](/docs/quick-start-guides/reactjs-quick-start/displaying-content-in-react).
