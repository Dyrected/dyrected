...
If JavaScript or TypeScript is not the consumer, drop down to the [REST API Overview](/docs/managing-data/rest-api/overview). For JavaScript and TypeScript inside Next.js, the SDK and `@dyrected/next` helpers should stay the default path.
...
Once that is true, continue to [Adding a Visual Editor in Next.js](/docs/quick-start-guides/nextjs-quick-start/adding-a-visual-editor-in-nextjs).
