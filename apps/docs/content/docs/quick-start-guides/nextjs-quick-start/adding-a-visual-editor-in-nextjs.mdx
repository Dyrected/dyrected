...
Once that is true, continue to [Let Editors Build Custom Pages in Next.js with Dyrected](/docs/quick-start-guides/nextjs-quick-start/building-landing-pages-for-marketing).
