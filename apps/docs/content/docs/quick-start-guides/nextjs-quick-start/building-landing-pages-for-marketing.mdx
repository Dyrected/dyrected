...
Use this page after [Adding a Visual Editor in Next.js](/docs/quick-start-guides/nextjs-quick-start/adding-a-visual-editor-in-nextjs). At this point, the important pieces should already exist:
...
Once that is true, your Next.js quick start is complete. When you are ready to give access to another person, continue to [Handing Off to Editors](/docs/features/authentication/handing-off-to-editors).
