...
- [Installing Dyrected](/docs/quick-start-guides/nextjs-quick-start/installing-dyrected)
...
Once you have the Cloud site and those three values, continue to [Installing Dyrected](/docs/quick-start-guides/nextjs-quick-start/installing-dyrected), which now covers the full Next.js setup flow.
...
Once those are true, continue to [Installing Dyrected](/docs/quick-start-guides/nextjs-quick-start/installing-dyrected).
