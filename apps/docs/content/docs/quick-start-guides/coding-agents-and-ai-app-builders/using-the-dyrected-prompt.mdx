...
If you are setting up Dyrected directly by hand in a self-hosted app, start with [Installation](/docs/basics/getting-started/installation) instead.
...
If you have not done that yet, start with [Setting Up Your Cloud Site](/docs/quick-start-guides/coding-agents-and-ai-app-builders/setting-up-your-cloud-site).
...
Use [Add Dyrected skill to your agent](/docs/quick-start-guides/coding-agents-and-ai-app-builders/add-dyrected-skill-to-your-agent) when you are working in a local agent runtime that supports installable skills and you want Dyrected knowledge loaded on demand.
...
If you prefer an active agent skill rather than a pasted prompt, continue to [Add Dyrected skill to your agent](/docs/quick-start-guides/coding-agents-and-ai-app-builders/add-dyrected-skill-to-your-agent).
