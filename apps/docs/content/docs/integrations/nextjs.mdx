...
> [!NOTE]
> The `@dyrected/next` package provides the specialized `<DyrectedAdmin />` component and utilities for seamless Next.js App Router integration.
...
Create a simple page at `app/admin/page.tsx`. This page will handle the root `/admin` and all internal admin sub-routes via hash-based navigation.
