...
runtime: variant
runtimeGroup: common-patterns-access-control
...
For the difference between creator, owner, and self rules, see [Dyrected Cloud access control](/docs/basics/access-control/cloud#createdbycurrentuser-vs-isowner).
...
- [Dyrected Cloud access control](/docs/basics/access-control/cloud)
