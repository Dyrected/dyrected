...
For the full install paths, use [Installation](/docs/start-here/installation).
...
- [Custom Admin Panel Location](/docs/editor-experience/custom-admin-panel-location)
...
- [Authentication Overview](/docs/editor-experience/editor-accounts)
- [Authentication Operations](/docs/deployment-and-operations/authentication/operations)
- [JWT Strategy](/docs/deployment-and-operations/authentication/jwt-strategy)
- [Cookie Strategy](/docs/deployment-and-operations/authentication/cookie-strategy)
...
- [Preview](/docs/editor-experience/preview)
- [Live Preview Overview](/docs/editor-experience/publishing/live-preview/overview)
- [Frontend](/docs/editor-experience/publishing/live-preview/frontend)
- [Server-side](/docs/editor-experience/publishing/live-preview/server-side)
...
Use [Email Overview](/docs/deployment-and-operations/infrastructure/email) for the transport setup and built-in email behavior.
...
For the config surface and defaults, use [Logging and Observability](/docs/deployment-and-operations/infrastructure/logging).
