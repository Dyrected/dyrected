...
<Callout type="warn">
  **Export CSV** ignores the current search and filters — it always returns the **whole** collection. For a subset, you
  ...
  [The Collection List](/docs/editor-experience/list-view)), or for a query-driven export, fetch the collection with
  the [SDK](/docs/deliver-content/sdk-api/overview) and build the CSV from the result.
</Callout>
