...
Every collection list has two layout modes. The default **List View** is for browsing and filtering (see [The Collection List](/docs/editor-experience/list-view)); **Spreadsheet View** is for bulk editing. Open the **View** button in the top-right of any list and choose **Spreadsheet** under Layout Mode.
