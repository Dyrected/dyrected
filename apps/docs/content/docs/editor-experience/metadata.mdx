...
Point it at any icon your app serves — an `.ico`, `.png`, or `.svg` at a path the browser can reach. For the rest of the branding options — logo, colors, and fonts — see [Customizing CSS](/docs/editor-experience/customizing-css).
