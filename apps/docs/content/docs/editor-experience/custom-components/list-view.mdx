...
By the end of this page you should know the four list slots, the rich set of props your slot components receive, and how to register them per collection. This page assumes the declare-then-provide pattern from the [Custom Components overview](/docs/editor-experience/custom-components/overview).
