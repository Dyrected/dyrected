...
<Callout type="info">
  ...
  [client-side (`postMessage`)](/docs/editor-experience/publishing/live-preview/client-side) instead.
</Callout>

## Turn it on

Set `previewMode: "token"` on the collection, alongside the `previewUrl` you already configured (see [Preview](/docs/editor-experience/preview)):
...
- [Client-side integration](/docs/editor-experience/publishing/live-preview/client-side) — the `postMessage` path, with live-as-you-type and click-to-edit.
- [Preview configuration](/docs/editor-experience/preview) — `previewUrl` and `previewMode` reference.
