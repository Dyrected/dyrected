---
title: Admin UI
description: How the Dyrected admin works, where it can live, and what changes when you embed it.
---
...
<TypeTable
  type={{
    baseUrl: {
      description: 'The base URL of your Dyrected API (e.g. `https://cms.mysite.com`).',
      type: 'string',
      required: true,
    },
    apiKey: {
      description: 'The Site API key used to authenticate all Admin requests.',
      type: 'string',
      required: true,
    },
    siteId: {
      description: 'The Site ID sent as `X-Site-Id` on every request (required in Cloud mode).',
      type: 'string',
    },
    basename: {
      description: 'The URL path prefix where the admin is mounted (default: `/admin`).',
      type: 'string',
    },
    onNavigate: {
      description: 'Called on every internal route change. Use this to sync the host router so browser history works correctly when embedded.',
      type: '(path: string) => void',
    },
    components: {
      description: 'Custom field components. See [Custom Field Components](#custom-field-components).',
      type: 'object',
    },
  }}
/>
...
<TypeTable
  type={{
    ...
    field: {
      description: 'The full field definition from your config.',
      type: 'FieldSchema',
    },
    readOnly: {
      description: 'Whether the field should be non-editable.',
      type: 'boolean',
    },
  }}
/>
