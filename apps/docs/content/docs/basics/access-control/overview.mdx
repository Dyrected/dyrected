...
This page is the model: what a rule is, the shapes it can take, when it runs, and what it can see. The pages that follow show where to put rules for [collections](/docs/basics/access-control/collections), [globals](/docs/basics/access-control/globals), and [fields](/docs/basics/access-control/fields).
