...
- Read [Overview](/docs/basics/configuration/overview) for the root config shape.
- Read [Collections](/docs/basics/configuration/collections) and [Globals](/docs/basics/configuration/globals) once your environment is in place.
- Go back to [Installation](/docs/basics/getting-started/installation) if you want the CLI-generated setup path first.
