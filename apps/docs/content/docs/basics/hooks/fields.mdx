...
If you are targeting Cloud, read [Cloud-safe hooks](/docs/basics/hooks/cloud) alongside this page. That page is the canonical guide for which field hook surfaces survive `sync:schema`.
...
For the exact declarative `beforeChange` context in Cloud-safe mode, see [Cloud-safe hooks](/docs/basics/hooks/cloud).
...
Move up to a [collection hook](/docs/basics/hooks/collections) or [global hook](/docs/basics/hooks/globals) when the logic depends on several fields, the operation, or post-write side effects.
...
For the exact declarative `admin.hooks.onChange` context in Cloud-safe mode, see [Cloud-safe hooks](/docs/basics/hooks/cloud).
...
- [Hooks overview](/docs/basics/hooks/overview) for the shared lifecycle model.
- [Cloud-safe hooks](/docs/basics/hooks/cloud) for the Cloud-specific subset and sync behavior.
- [Collection hooks](/docs/basics/hooks/collections) when the logic grows beyond one field.
- [Fields overview](/docs/basics/fields/overview) for the rest of the field config surface.
- [Hook context](/docs/basics/hooks/context) for the `user`, `req`, `doc`, and `data` values these hooks receive.
