...
- [Hooks overview](/docs/basics/hooks/overview) for the full hook family map.
- [Collection hooks](/docs/basics/hooks/collections) for document-level lifecycle details.
- [Global hooks](/docs/basics/hooks/globals) for singleton config hooks.
- [Field hooks](/docs/basics/hooks/fields) for value-level transforms and admin reactivity.
