...
- `name` — the persisted key. A rename is a data migration, so plan it with [database migrations](/docs/basics/database/migrations) or the `renameTo` fallback.
...
- `promoted` — pulls the field out of the JSON document into its own indexed column so you can filter and sort on it quickly. See [Database indexes](/docs/basics/database/indexes).
- `access` — per-field `read` and `update` rules that hide or lock the field for some users. See [Field access control](/docs/basics/access-control/fields).
...
- Text-like content: [Text](/docs/basics/fields/text), [Textarea](/docs/basics/fields/textarea), [Email](/docs/basics/fields/email), [URL](/docs/basics/fields/url), [Icon](/docs/basics/fields/icon), [Rich Text](/docs/basics/fields/rich-text)
- Choices and toggles: [Select](/docs/basics/fields/select), [Multi Select](/docs/basics/fields/multi-select), [Radio](/docs/basics/fields/radio), [Boolean](/docs/basics/fields/boolean)
- Numbers and dates: [Number](/docs/basics/fields/number), [Date](/docs/basics/fields/date), [Datetime](/docs/basics/fields/datetime), [Time](/docs/basics/fields/time)
- Structure and nesting: [Object](/docs/basics/fields/object), [Array](/docs/basics/fields/array), [Blocks](/docs/basics/fields/blocks), [Row](/docs/basics/fields/row)
- Relationships and files: [Relationship](/docs/basics/fields/relationship), [Image](/docs/basics/fields/image), [Join](/docs/basics/fields/join)
- Data and layout: [JSON](/docs/basics/fields/json)
