...
Reach for [Date](/docs/basics/fields/date) when only the calendar day matters, or [Time](/docs/basics/fields/time) when you need a time of day whose date lives elsewhere.
