...
- If Cloud is right, start with [Setting Up Your Cloud Site](/docs/quick-start-guides/coding-agents-and-ai-app-builders/setting-up-your-cloud-site).
- If you want the framework path first, start with [Installation](/docs/basics/getting-started/installation).
- If you want the side-by-side capability table, read [Cloud vs Self-hosted](/docs/basics/getting-started/cloud-vs-self-hosted).
