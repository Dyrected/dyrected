...
Start here when you want the main setup surface: [Configuration Overview](/docs/basics/configuration/overview).
...
Schema behavior and storage setup are best paired with [Database Overview](/docs/basics/database/overview) and [Configuration Overview](/docs/basics/configuration/overview).
...
If the content has many instances, it usually belongs in a collection. The closest starting point today is [Configuration Overview](/docs/basics/configuration/overview).
...
If there is one shared version of the content for the whole site, it usually belongs in a global. The closest starting point today is [Configuration Overview](/docs/basics/configuration/overview).
...
Start with [Fields Overview](/docs/basics/fields/overview) for the mental model.
...
The closest place for this topic today is [Fields Overview](/docs/basics/fields/overview), since relationships are part of how fields shape documents.
...
See [Hooks Overview](/docs/basics/hooks/overview).
...
See [Authentication Overview](/docs/features/authentication/overview) and [Operations](/docs/features/authentication/operations).
...
See [Access Control Overview](/docs/basics/access-control/overview).
...
See [Admin Overview](/docs/features/admin/overview).
...
See [Workflows Overview](/docs/features/workflows/overview) for the current published guide.
...
See [REST API Overview](/docs/managing-data/rest-api/overview).
...
See [SDK API Overview](/docs/managing-data/sdk-api/overview).

### OpenAPI

Dyrected also generates an API contract from your config at runtime. Until there is a dedicated OpenAPI page, the closest related overview is [REST API Overview](/docs/managing-data/rest-api/overview).
...
If this mental model feels clear, continue to [Installation](/docs/basics/getting-started/installation). If you want the practical setup path after that, go to the quick start guide that matches your frontend: [Next.js](/docs/quick-start-guides/nextjs-quick-start/overview), [Nuxt](/docs/quick-start-guides/nuxtjs-quick-start/overview), [React](/docs/quick-start-guides/reactjs-quick-start/overview), or [Vue](/docs/quick-start-guides/vuejs-quick-start/overview).
