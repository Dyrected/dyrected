...
Depth pairs naturally with [filter](/docs/managing-data/sdk-api/filter) and [sort](/docs/managing-data/sdk-api/sort) — you can narrow, order, and populate in the same call, and the populated documents respect your `where` and `sort`.
