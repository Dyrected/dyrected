...
Once you've selected the right documents, [sort](/docs/managing-data/sdk-api/sort) puts them in order and [pagination](/docs/managing-data/sdk-api/pagination) controls how many you get back at a time.
