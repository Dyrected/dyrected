...
The dedicated page for that workflow is [InferSchema](/docs/reference/typescript/infer-schema).
...
If your app cannot import those schema constants cleanly, switch to [Generating Types](/docs/reference/typescript/generating-types) instead of forcing a brittle import boundary.
...
The next page covers that flow in detail: [Generating Types](/docs/reference/typescript/generating-types).
...
- [InferSchema](/docs/reference/typescript/infer-schema) for the same-repo typed SDK workflow built from exported schema constants
- [Generating Types](/docs/reference/typescript/generating-types) for the CLI workflow and generated-file shape
- [SDK Overview](/docs/deliver-content/sdk-api/overview) for the full client surface after your schema typing is in place
