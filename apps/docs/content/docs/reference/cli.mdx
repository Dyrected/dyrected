...
To go further — installing the Dyrected agent skill and getting the most out of an AI assistant — see [Coding agents and AI app builders](/docs/guides/ai-and-coding-agents/add-dyrected-skill-to-your-agent).
...
- [Generating Types](/docs/reference/typescript/generating-types) — the full type-generation workflow and what the generated file contains.
- [Configuration Overview](/docs/model-content/configuration/overview) — what the `dyrected.config.ts` that these commands act on actually holds.
- [Production deployment](/docs/deployment-and-operations/production/deployment) — where `sync:schema` fits into a Cloud deploy.
