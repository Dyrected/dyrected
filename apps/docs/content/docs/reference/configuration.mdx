...
| <code>siteUrl</code> | <code>siteUrl?: string</code> | The canonical/base URL of the frontend website for links and iframe live previews. |
...
| <code>initialData</code> | <code>initialData?: Partial&lt;TDoc&gt;[]</code> | Initial documents to seed into this collection the first time it is fetched and found to be empty, for example demo data or defaults. |
