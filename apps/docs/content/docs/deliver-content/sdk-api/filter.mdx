...
Once you've selected the right documents, [sort](/docs/deliver-content/sdk-api/sort) puts them in order and [pagination](/docs/deliver-content/sdk-api/pagination) controls how many you get back at a time.
