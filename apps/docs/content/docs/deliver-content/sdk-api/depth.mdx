...
Depth pairs naturally with [filter](/docs/deliver-content/sdk-api/filter) and [sort](/docs/deliver-content/sdk-api/sort) — you can narrow, order, and populate in the same call, and the populated documents respect your `where` and `sort`.
