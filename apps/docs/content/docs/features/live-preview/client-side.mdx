...
This is the implementation page. It assumes you've read the [overlay model](/docs/features/live-preview/frontend) and have `admin.previewUrl` set (see [Preview](/docs/features/admin/preview)). Here you'll wire the hook, make elements click-to-edit, and secure the message origin.
