...
For the exact type signature, the root configuration reference still lives on [Configuration Overview](/docs/basics/configuration/overview).
...
For the endpoint-by-endpoint behavior, use [Authentication Operations](/docs/features/authentication/operations).
...
Keep the auth endpoint semantics on [Authentication Operations](/docs/features/authentication/operations). This page is for the transport setup, the built-in email triggers, and template customization.
