...
For complete, copy-paste recipes — a legal approval chain, maker–checker sign-off, scheduled publishing, translation gating, and a newsroom pipeline — see [Custom workflows](/docs/features/workflows/custom-workflows).
