...
That is different from adding an [`image` field](/docs/basics/fields/image) to another collection. The `image` field stores a relationship to an existing upload document. The upload collection is the canonical home for the file itself.
...
- go to [Storage adapters](/docs/features/upload/storage-adapters) when you are choosing a provider or wiring credentials
...
- [Storage adapters](/docs/features/upload/storage-adapters) for provider setup and adapter behavior
- [Image field](/docs/basics/fields/image) for relating other documents to uploads
- [Installation](/docs/basics/getting-started/installation) for which adapters the CLI can scaffold for you
