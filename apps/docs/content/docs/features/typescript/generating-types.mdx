...
If your schema and SDK usage live in one codebase, start with the simpler path from [TypeScript Overview](/docs/features/typescript/overview): export your schema constants and derive the client type with `InferSchema`.
...
If you find yourself needing deeper compile-time control inside the schema code itself, go back to the inference-first path from [TypeScript Overview](/docs/features/typescript/overview).
