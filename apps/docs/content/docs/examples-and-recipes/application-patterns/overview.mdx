...
### [Content modeling](/docs/examples-and-recipes/application-patterns/content-modeling)
...
### [Access control](/docs/examples-and-recipes/application-patterns/access-control)

Patterns for row-level access, role-based permissions, and deciding who can read, update, or delete which records.

### [Admin experience](/docs/examples-and-recipes/application-patterns/admin-experience)

Patterns for making the Admin UI react to editor input, reveal fields only when needed, and keep forms easier to use.

### [Custom app surfaces](/docs/examples-and-recipes/application-patterns/custom-app-surfaces)
...
### [Data lifecycle](/docs/examples-and-recipes/application-patterns/data-lifecycle)

Patterns for slugs, cross-field validation, and schema changes that need to stay safe as content evolves over time.

### [Workflows](/docs/examples-and-recipes/application-patterns/workflows)

Patterns for draft, review, and publishing flows when content needs approval before it goes live.

### [Integrations](/docs/examples-and-recipes/application-patterns/integrations)
