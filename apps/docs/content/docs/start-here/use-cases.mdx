...
- Compare capabilities in [Cloud vs Self-hosted](/docs/start-here/cloud-vs-self-hosted).
- Choose a setup path in [Choose a Runtime](/docs/start-here/choose-a-runtime).
- Continue to [Installation](/docs/start-here/installation) when you are ready to wire a project.
