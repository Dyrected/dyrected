...
Use this page after [Adding a Visual Editor in React](/docs/guides/react/adding-a-visual-editor-in-reactjs). At this point, the important pieces should already exist:
