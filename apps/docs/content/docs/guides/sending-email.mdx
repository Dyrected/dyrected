...
Email runs through a single `send` callback in your config. Dyrected hands it the recipient, subject, and rendered HTML; you forward those to whatever provider you use. Here it is with [Resend](https://resend.com), a solid default:
