...
- [Installing Dyrected](/docs/guides/nextjs/installing-dyrected)
...
Once you have the Cloud site and those three values, continue to [Installing Dyrected](/docs/guides/nextjs/installing-dyrected), which now covers the full Next.js setup flow.
...
Once those are true, continue to [Installing Dyrected](/docs/guides/nextjs/installing-dyrected).
