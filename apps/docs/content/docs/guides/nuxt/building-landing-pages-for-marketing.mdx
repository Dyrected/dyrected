...
Use this page after [Adding a Visual Editor in Nuxt](/docs/guides/nuxt/adding-a-visual-editor-in-nuxtjs). At this point, the important pieces should already exist:
...
- [Defining a Schema](/docs/guides/nuxt/defining-a-schema) shaped the content model
- [Setting Up Initial Data](/docs/guides/nuxt/setting-up-initial-data) made the first load non-empty
- [Displaying Content in Nuxt](/docs/guides/nuxt/displaying-content-in-nuxtjs) made the frontend render real content
- [Adding a Visual Editor in Nuxt](/docs/guides/nuxt/adding-a-visual-editor-in-nuxtjs) made editors preview and click into that content
