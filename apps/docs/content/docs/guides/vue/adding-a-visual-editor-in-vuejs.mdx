...
```vue
<script setup lang="ts">
import { useDyPath } from "@dyrected/vue";
...
Once that is true, continue to [Let Editors Build Custom Pages in Vue with Dyrected](/docs/guides/frameworks/vue/building-landing-pages-for-marketing).
