...
If JavaScript is not the consumer, drop down to the [REST API Overview](/docs/deliver-content/rest-api/overview). For Vue SPAs, the SDK and `@dyrected/vue` helpers should stay the default path.
...
Once that is true, continue to [Adding a Visual Editor in Vue](/docs/guides/frameworks/vue/adding-a-visual-editor-in-vuejs).
