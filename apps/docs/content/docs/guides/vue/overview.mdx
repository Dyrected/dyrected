...
1. **Step 1:** [Install Dyrected](/docs/guides/vue/installing-dyrected) and connect the app to Dyrected Cloud.
2. **Step 2:** [Define the first schema](/docs/guides/vue/defining-a-schema) your app actually needs.
3. **Step 3:** [Create your first content](/docs/guides/vue/creating-your-first-content) so the frontend is not wiring against an empty CMS.
4. **Step 4:** [Display that content in Vue](/docs/guides/vue/displaying-content-in-vuejs).
5. **Step 5:** Add a [visual editor workflow](/docs/guides/vue/adding-a-visual-editor-in-vuejs).
6. **Step 6:** [Let editors build custom pages in Vue](/docs/guides/vue/building-landing-pages-for-marketing).
...
If that is the target, continue to [Installing Dyrected](/docs/guides/vue/installing-dyrected).
