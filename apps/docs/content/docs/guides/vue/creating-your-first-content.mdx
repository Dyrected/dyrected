...
If you need the deeper content-model background, go back to [Defining a Schema](/docs/guides/vue/defining-a-schema) and then use the broader [Collections](/docs/model-content/configuration/collections) and [Globals](/docs/model-content/configuration/globals) references.
...
Once that is true, continue to [Displaying Content in Vue](/docs/guides/vue/displaying-content-in-vuejs).
