...
If you are working in an AI app builder such as Lovable, Bolt, or v0, the safer default is still [Using the Dyrected prompt](/docs/guides/ai-and-coding-agents/using-the-dyrected-prompt). Those tools usually need a guided prompt and approval flow more than an installable local skill.
