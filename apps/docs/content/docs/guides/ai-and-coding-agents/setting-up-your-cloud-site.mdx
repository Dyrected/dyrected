...
If you want Dyrected fully self-hosted inside your Next.js or Nuxt app instead, start with [Installation](/docs/start-here/installation).
...
That flow is explained in [Using the Dyrected prompt](/docs/guides/ai-and-coding-agents/using-the-dyrected-prompt).
...
If those four things are true, continue to [Using the Dyrected prompt](/docs/guides/ai-and-coding-agents/using-the-dyrected-prompt).
