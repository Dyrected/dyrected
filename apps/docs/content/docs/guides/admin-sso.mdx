...
<Accordion title="Admin auth provider not found.">
Meaning:
...
<Accordion title="Missing OIDC callback parameters.">
Meaning:
...
<Accordion title="Failed to load OIDC discovery document.">
Meaning:
...
<Accordion title="OIDC token exchange failed.">
Meaning:
...
<Accordion title="OIDC nonce verification failed. or OIDC state verification failed.">
Meaning:
...
<Accordion title="External identity is missing a subject.">
Meaning:
...
<Accordion title="This account has not been provisioned for admin access.">
Meaning:
...
<Accordion title="Access denied for this site.">
Meaning:
...
<Accordion title="Login succeeds, but /me fails">
Meaning:
