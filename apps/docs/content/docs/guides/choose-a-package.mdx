...
- If you are building a **Next.js** app, start with [`@dyrected/next`](/docs/guides/nextjs/package-reference).
- If you are building a **Nuxt** app, start with [`@dyrected/nuxt`](/docs/guides/nuxt/package-reference).
- If you already have a running Dyrected API and need a **React** integration, use [`@dyrected/react`](/docs/guides/react/package-reference).
- If you already have a running Dyrected API and need a **Vue** integration, use [`@dyrected/vue`](/docs/guides/vue/package-reference).
- If you only need a typed client and no framework glue, use [`@dyrected/sdk`](/docs/guides/sdk).
