...
Use this page after [Adding a Visual Editor in Next.js](/docs/guides/frameworks/nextjs/adding-a-visual-editor-in-nextjs). This is the page where schema, rendering, and visual preview finally become one complete workflow for editors. At this point, the important pieces should already exist:
...
If you need the shared rendering pattern first, go back to [Displaying Content in Next.js](/docs/guides/frameworks/nextjs/displaying-content-in-nextjs), especially the section on rendering blocks.
...
- [Defining a Schema](/docs/guides/frameworks/nextjs/defining-a-schema) shaped the content model
- [Setting Up Initial Data](/docs/guides/frameworks/nextjs/setting-up-initial-data) made the first load non-empty
- [Displaying Content in Next.js](/docs/guides/frameworks/nextjs/displaying-content-in-nextjs) made the frontend render real content
- [Adding a Visual Editor in Next.js](/docs/guides/frameworks/nextjs/adding-a-visual-editor-in-nextjs) made editors preview and click into that content
