...
If you are already in Next.js, prefer [`@dyrected/next`](/docs/guides/frameworks/nextjs/package-reference) instead.
...
Use `useDyrected()` when a component needs the shared SDK client from `DyrectedProvider`. For the full rendering workflow, use [Displaying Content in React](/docs/guides/frameworks/react/displaying-content-in-react).
...
For the guided flow, use [Adding a Visual Editor in React](/docs/guides/frameworks/react/adding-a-visual-editor-in-reactjs).
...
- [SDK](/docs/guides/frameworks/sdk)
- [Displaying content in React](/docs/guides/frameworks/react/displaying-content-in-react)
