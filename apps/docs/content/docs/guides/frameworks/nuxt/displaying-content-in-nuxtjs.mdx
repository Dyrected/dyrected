...
If JavaScript or TypeScript is not the consumer, drop down to the [REST API Overview](/docs/deliver-content/rest-api/overview). For JavaScript and TypeScript inside Nuxt, the SDK and `@dyrected/nuxt` helpers should stay the default path.
...
Once that is true, continue to [Adding a Visual Editor in Nuxt](/docs/guides/frameworks/nuxt/adding-a-visual-editor-in-nuxtjs).
