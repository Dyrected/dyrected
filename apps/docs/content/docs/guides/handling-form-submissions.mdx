...
## 2. Submit with the SDK (recommended)
...
- **Notifications**: To email your team when a submission comes in, add an `afterChange` hook to the collection — see [Using Hooks](/docs/guides/using-hooks) and [Sending Email](/docs/guides/sending-email).
