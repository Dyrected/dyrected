...
If this mental model feels clear, continue to [Installation](/docs/start-here/installation). If you want the practical setup path after that, go to the quick start guide that matches your frontend: [Next.js](/docs/guides/frameworks/nextjs/overview), [Nuxt](/docs/guides/frameworks/nuxt/overview), [React](/docs/guides/frameworks/react/overview), or [Vue](/docs/guides/frameworks/vue/overview).
