...
On your frontend, render the stored HTML with the [`DyrectedRichText` component](/docs/deliver-content/displaying-content/overview). Because the value is HTML authored through the admin panel, render content you trust and sanitize it upstream if untrusted users can edit it.
