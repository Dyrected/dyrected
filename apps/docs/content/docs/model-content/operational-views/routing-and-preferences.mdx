...
Every `defineView` becomes a URL, a sidebar item, and a set of localStorage keys that remember each editor's column and toolbar choices.

By the end you'll know the route shape, what the sidebar actually renders, and how preferences stick per view.
