...
export interface CollectionConfig<TDoc extends object = Record<string, unknown>> {
  ...
  /**
   * Presentation schema defining the layout and fields displayed in the Record Detail View.
   *
   * @see {@link https://dyrected.com/docs/admin/detail-views Detail Views overview}
   */
  detail?: DetailSchema<TDoc>;
}
```
...
| <code>detail</code> (optional) | Presentation schema defining the layout and fields displayed in the Record Detail View.  See: [Detail Views overview](https://dyrected.com/docs/admin/detail-views) |
