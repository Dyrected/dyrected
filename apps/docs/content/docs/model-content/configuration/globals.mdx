...
export interface GlobalConfig<TDoc extends object = Record<string, unknown>> {
  ...
  /**
   * Presentation schema defining the layout and fields displayed in the Global Detail View.
   *
...
| <code>detail</code> (optional) | Presentation schema defining the layout and fields displayed in the Global Detail View.  See: [Detail Views overview](https://dyrected.com/docs/admin/detail-views) |
