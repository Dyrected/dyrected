...
For the full compatibility table, exact expression contexts, and what `sync:schema` preserves or strips, read [Cloud-safe hooks](/docs/model-content/content-rules/cloud-safe-hooks).
