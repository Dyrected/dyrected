...
If you are new to hooks themselves, start with the [Hooks overview](/docs/model-content/content-rules/hooks). This page is the Cloud-specific guide.
...
- [Hooks overview](/docs/model-content/content-rules/hooks) for the overall hook model.
- [Collection hooks](/docs/deployment-and-operations/server-runtime/hooks/collections) for collection lifecycle guidance.
- [Global hooks](/docs/deployment-and-operations/server-runtime/hooks/globals) for singleton lifecycle guidance.
- [Field hooks](/docs/deployment-and-operations/server-runtime/hooks/fields) for field-level and admin hook behavior.
- [CLI](/docs/reference/cli) for `sync:schema` behavior.
