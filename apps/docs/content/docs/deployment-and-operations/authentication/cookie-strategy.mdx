...
By the end of this page you should know the options, which one to reach for by default, and what each choice does to your exposure. If you want the signing mechanics behind the token, see [JWT Strategy](/docs/deployment-and-operations/authentication/jwt-strategy).
...
- [JWT Strategy](/docs/deployment-and-operations/authentication/jwt-strategy) — how the token is signed and how long it lasts
- [Operations](/docs/deployment-and-operations/authentication/operations) — the login and logout endpoints
- [Token Data](/docs/deployment-and-operations/authentication/token-data) — what the stored token actually contains
