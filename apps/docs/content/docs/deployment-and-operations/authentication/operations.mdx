...
- any `data` you pass during invite, such as a role field, is stored on that pending record
- the invited user cannot log in yet; login returns a pending-invite error until they accept
