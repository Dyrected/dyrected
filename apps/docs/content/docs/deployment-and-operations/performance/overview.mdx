...
That gives the database a real column instead of forcing repeated JSON extraction. For the full behavior, see [Indexes](/docs/deployment-and-operations/infrastructure/database/indexes).
...
- [Indexes](/docs/deployment-and-operations/infrastructure/database/indexes)
