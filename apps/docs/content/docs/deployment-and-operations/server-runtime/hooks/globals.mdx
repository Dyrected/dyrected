...
For Cloud-safe `afterRead` details, including the exact expression context, see [Cloud-safe hooks](/docs/model-content/content-rules/cloud-safe-hooks).
...
For Cloud-safe `beforeChange` details, including the exact expression context, see [Cloud-safe hooks](/docs/model-content/content-rules/cloud-safe-hooks).
...
If you need per-document logic on many records, that belongs on a [collection hook](/docs/deployment-and-operations/server-runtime/hooks/collections), not a global.

## Related pages

- [Hooks overview](/docs/model-content/content-rules/hooks) for the shared mental model.
- [Cloud-safe hooks](/docs/model-content/content-rules/cloud-safe-hooks) for the Cloud-specific subset and sync behavior.
- [Collection hooks](/docs/deployment-and-operations/server-runtime/hooks/collections) for repeatable content.
- [Global configuration](/docs/model-content/configuration/globals) for the rest of the global config surface.
- [Hook context](/docs/deployment-and-operations/server-runtime/hooks/context) for the request and user data hook functions receive.
