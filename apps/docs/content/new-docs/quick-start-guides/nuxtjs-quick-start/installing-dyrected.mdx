...
For the full troubleshooting guide, see [Troubleshooting](/new-docs/features/troubleshooting/troubleshooting). That is the right top-level home for deeper error-by-error fixes.
...
Once those are true, continue to [Defining a Schema](/new-docs/quick-start-guides/nuxtjs-quick-start/defining-a-schema).
