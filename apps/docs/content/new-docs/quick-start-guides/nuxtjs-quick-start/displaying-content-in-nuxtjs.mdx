...
If JavaScript or TypeScript is not the consumer, drop down to the [REST API Overview](/new-docs/managing-data/rest-api/overview). For JavaScript and TypeScript inside Nuxt, the SDK and `@dyrected/nuxt` helpers should stay the default path.
...
Once that is true, continue to [Adding a Visual Editor in Nuxt](/new-docs/quick-start-guides/nuxtjs-quick-start/adding-a-visual-editor-in-nuxtjs).
