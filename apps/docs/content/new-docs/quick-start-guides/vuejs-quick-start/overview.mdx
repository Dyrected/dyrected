...
1. **Step 1:** [Install Dyrected](/new-docs/quick-start-guides/vuejs-quick-start/installing-dyrected) and connect the app to Dyrected Cloud.
2. **Step 2:** [Define the first schema](/new-docs/quick-start-guides/vuejs-quick-start/defining-a-schema) your app actually needs.
3. **Step 3:** [Create your first content](/new-docs/quick-start-guides/vuejs-quick-start/creating-your-first-content) so the frontend is not wiring against an empty CMS.
4. **Step 4:** [Display that content in Vue](/new-docs/quick-start-guides/vuejs-quick-start/displaying-content-in-vuejs).
5. **Step 5:** Add a [visual editor workflow](/new-docs/quick-start-guides/vuejs-quick-start/adding-a-visual-editor-in-vuejs).
6. **Step 6:** [Let editors build custom pages in Vue](/new-docs/quick-start-guides/vuejs-quick-start/building-landing-pages-for-marketing).
...
If that is the target, continue to [Installing Dyrected](/new-docs/quick-start-guides/vuejs-quick-start/installing-dyrected).
