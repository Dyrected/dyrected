...
Use this page when your schema exists but a fresh environment would otherwise open with blank collections, blank globals, and nothing useful to render.
...
Once that is true, continue to [Displaying Content in Next.js](/new-docs/quick-start-guides/nextjs-quick-start/displaying-content-in-nextjs).
