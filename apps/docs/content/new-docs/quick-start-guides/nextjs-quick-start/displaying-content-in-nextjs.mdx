...
import { getDyrectedClient, DyrectedImage, DyrectedRichText } from "@dyrected/next";
...
If JavaScript or TypeScript is not the consumer, drop down to the [REST API Overview](/new-docs/managing-data/rest-api/overview). For JavaScript and TypeScript inside Next.js, the SDK and `@dyrected/next` helpers should stay the default path.

For broader component coverage beyond the quick-start use case, continue to [Displaying Content Overview](/new-docs/managing-data/displaying-content/overview) and [SDK API Overview](/new-docs/managing-data/sdk-api/overview).
...
Once that is true, continue to [Adding a Visual Editor in Next.js](/new-docs/quick-start-guides/nextjs-quick-start/adding-a-visual-editor-in-nextjs).
