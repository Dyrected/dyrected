...
Use this page after [Installing Dyrected](/new-docs/quick-start-guides/nextjs-quick-start/installing-dyrected). At this point, Dyrected is already mounted into your app and `/admin` should load. The next job is to turn the starter config into a schema that matches your real site instead of the generic example content.
...
Once that is true, continue to [Building Landing Pages for Marketing](/new-docs/quick-start-guides/nextjs-quick-start/building-landing-pages-for-marketing).
