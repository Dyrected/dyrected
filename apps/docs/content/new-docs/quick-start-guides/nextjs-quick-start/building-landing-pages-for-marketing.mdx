...
Use this page after [Adding a Visual Editor in Next.js](/new-docs/quick-start-guides/nextjs-quick-start/adding-a-visual-editor-in-nextjs). At this point, the important pieces should already exist:
...
- [Defining a Schema](/new-docs/quick-start-guides/nextjs-quick-start/defining-a-schema) shaped the content model
- [Setting Up Initial Data](/new-docs/quick-start-guides/nextjs-quick-start/setting-up-initial-data) made the first load non-empty
- [Displaying Content in Next.js](/new-docs/quick-start-guides/nextjs-quick-start/displaying-content-in-nextjs) made the frontend render real content
- [Adding a Visual Editor in Next.js](/new-docs/quick-start-guides/nextjs-quick-start/adding-a-visual-editor-in-nextjs) made editors preview and click into that content
...
- [Displaying Content in Next.js](/new-docs/quick-start-guides/nextjs-quick-start/displaying-content-in-nextjs)
