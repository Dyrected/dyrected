...
Use this page when the first content model is already clear and you want your React app to fetch something real before you wire deeper rendering logic.
...
If you need the deeper content-model background, go back to [Defining a Schema](/new-docs/quick-start-guides/reactjs-quick-start/defining-a-schema) and then use the broader [Collections](/new-docs/basics/configuration/collections) and [Globals](/new-docs/basics/configuration/globals) references.
...
Once that is true, continue to [Displaying Content in React](/new-docs/quick-start-guides/reactjs-quick-start/displaying-content-in-react).
