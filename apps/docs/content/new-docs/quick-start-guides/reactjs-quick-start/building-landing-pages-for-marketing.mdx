...
Use this page after [Adding a Visual Editor in React](/new-docs/quick-start-guides/reactjs-quick-start/adding-a-visual-editor-in-reactjs). At this point, the important pieces should already exist:
...
- a React renderer that maps each `blockType` to a real component
...
The dashboard is only half of the workflow. Every approved block also needs a matching React component in the frontend.
...
- [Displaying Content in React](/new-docs/quick-start-guides/reactjs-quick-start/displaying-content-in-react)

## Success check

You are ready to call the React quick start structurally complete when:
