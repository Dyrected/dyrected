...
If you want Dyrected fully self-hosted inside your Next.js or Nuxt app instead, start with [Installation](/new-docs/basics/getting-started/installation).
...
That flow is explained in [Using the Dyrected prompt](/new-docs/quick-start-guides/coding-agents-and-ai-app-builders/using-the-dyrected-prompt).
...
If those four things are true, continue to [Using the Dyrected prompt](/new-docs/quick-start-guides/coding-agents-and-ai-app-builders/using-the-dyrected-prompt).
