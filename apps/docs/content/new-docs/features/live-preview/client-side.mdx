...
This is the implementation page. It assumes you've read the [overlay model](/new-docs/features/live-preview/frontend) and have `admin.previewUrl` set (see [Preview](/new-docs/features/admin/preview)). Here you'll wire the hook, make elements click-to-edit, and secure the message origin.
