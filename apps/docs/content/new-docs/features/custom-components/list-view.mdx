...
By the end of this page you should know the four list slots, the rich set of props your slot components receive, and how to register them per collection. This page assumes the declare-then-provide pattern from the [Custom Components overview](/new-docs/features/custom-components/overview).
...
In a Vue or Nuxt app, register Vue components in the same `collectionList` map; they're wrapped automatically and receive the props above as Vue props. See the [overview](/new-docs/features/custom-components/overview#using-vue-components).
