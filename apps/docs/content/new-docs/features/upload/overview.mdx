...
That is different from adding an [`image` field](/new-docs/basics/fields/image) to another collection. The `image` field stores a relationship to an existing upload document. The upload collection is the canonical home for the file itself.
...
- go to [Storage adapters](/new-docs/features/upload/storage-adapters) when you are choosing a provider or wiring credentials
...
- [Storage adapters](/new-docs/features/upload/storage-adapters) for provider setup and adapter behavior
- [Image field](/new-docs/basics/fields/image) for relating other documents to uploads
- [Installation](/new-docs/basics/getting-started/installation) for which adapters the CLI can scaffold for you
