...
- **Admin affordances**: a Live/Draft badge in the editor header, and a Versions panel with the document's history.
...
For complete, copy-paste recipes — a legal approval chain, maker–checker sign-off, scheduled publishing, translation gating, and a newsroom pipeline — see [Custom workflows](/new-docs/features/workflows/custom-workflows).
