...
- [Hooks overview](/new-docs/basics/hooks/overview) for the full hook family map.
- [Collection hooks](/new-docs/basics/hooks/collections) for document-level lifecycle details.
- [Global hooks](/new-docs/basics/hooks/globals) for singleton config hooks.
- [Field hooks](/new-docs/basics/hooks/fields) for value-level transforms and admin reactivity.
