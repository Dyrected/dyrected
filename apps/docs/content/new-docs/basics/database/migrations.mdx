...
```ts
{ name: 'status', type: 'select', label: 'Status', options: ['draft', 'published'], defaultValue: 'draft' }
```
...
For the deployment side of this, see [Deployment](/new-docs/deployment/production/deployment).
