...
Read the [Access Control overview](/new-docs/basics/access-control/overview) first for the shared model — the four rule shapes and the context a rule receives. This page covers the two rules a global supports.
...
Global rules run on the server with the standard [access context](/new-docs/basics/access-control/overview#what-a-rule-can-see). The useful values here are:
...
- [Global hooks](/new-docs/basics/hooks/globals) — for logic that transforms data or raises custom errors, beyond allow/deny.
