...
|---|---|---|
| [Collections](/new-docs/basics/access-control/collections) | `read`, `create`, `update`, `delete` | Whole documents in a collection |
| [Globals](/new-docs/basics/access-control/globals) | `read`, `update` | A single global document |
| [Fields](/new-docs/basics/access-control/fields) | `read`, `update` | Individual fields — stripped from responses or dropped on writes |
