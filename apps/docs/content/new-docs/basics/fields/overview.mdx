...
- Choices and toggles: [Select](/new-docs/basics/fields/select), [Multi-select](/new-docs/basics/fields/multi-select), [Radio Group](/new-docs/basics/fields/radio-group), [Checkbox](/new-docs/basics/fields/checkbox)
- Numbers and dates: [Number](/new-docs/basics/fields/number), [Date](/new-docs/basics/fields/date), [Date and Time](/new-docs/basics/fields/datetime), [Time](/new-docs/basics/fields/time)
